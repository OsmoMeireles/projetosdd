...
#SOLICITAÇÃO OTR
url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQoayxEU-oZV2JxM1cZ2ZqjGAv4WSsEz3wEmdBYQEZO7lOtxF1K3lWEFS0hRAD3LRZcXg8rgg4PXlgC/pub?output=csv"
tabelaurl = pd.read_csv(url)

solAMPM = tabelaurl.groupby(['PERÍODO', 'DATA', 'VAN SDD', 'VUC SDD'], as_index = False) ['UTILITÁRIOS SDD'].sum()
solAM = solAMPM.loc[solAMPM['PERÍODO']=='AM']
solPM = solAMPM.loc[solAMPM['PERÍODO']=='PM']
print(solAMPM)

#CALENDARIZAÇÃO
calen = tabelaurl.groupby(['TIPO', 'DATA', 'VAN SDD', 'VUC SDD'], as_index = False) ['UTILITÁRIOS SDD'].sum()
...
disptp = tabelaurl.groupby(['TIPO', 'DATA', 'VAN SDD', 'VUC SDD'], as_index = False) ['UTILITÁRIOS SDD'].sum()
